        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              You have been invited to join the MIRA platform by your administrator. Your account
              has been set up with the following details:
            </Text>
          ...
          <Section style={footerSection}>
            <Text style={footer}>
              This invitation was sent from the MIRA Admin system. If you believe this is a mistake,
              please disregard this email.
            </Text>
            <Text style={footerLink}>&copy; {new Date().getFullYear()} MIRA IT Department</Text>
          </Section>
        </Container>
      </Body>
    </Html>
