  ...
  return (
    <>
      <div
        ...
        className="bg-white w-full max-w-[800px] shadow-sm border border-slate-200 px-10 py-12 md:px-16 md:py-16 text-black relative print:shadow-none print:border-0 print:p-0 print:m-0 mx-auto"
        style={{
      ...
      >
        ...
        <div className="border-b-2 border-black pb-4 mb-8 flex items-end justify-between">
          ...
          <div className="text-right">
            <p className="text-[10px] uppercase tracking-widest text-gray-500 font-sans font-bold">Document Ref</p>
        ...
        <div className="flex justify-between mb-8 text-sm">
          <div>
            <span className="font-bold">Date:</span> {morData.date || new Date().toLocaleDateString()}
          </div>
          <div>
        ...
        <div className="space-y-6 text-[15px] leading-relaxed">
          <p>
            This Memorandum of Receipt (MOR) serves to officially document the transfer of custody for the IT hardware asset(s) detailed below.
          </p>

          <div className="pl-6 border-l-2 border-black py-2 my-6">
            <div className="grid grid-cols-[120px_1fr] gap-y-3">
              <div className="font-bold text-gray-600 uppercase text-xs tracking-wider pt-0.5">Recipient</div>
              <div className="font-bold text-base">{morData.userQuery}</div>

              <div className="font-bold text-gray-600 uppercase text-xs tracking-wider pt-0.5">Department</div>
              <div>{morData.department}</div>

              <div className="font-bold text-gray-600 uppercase text-xs tracking-wider pt-0.5">Asset Details</div>
              <div className="font-bold text-base bg-gray-100 px-2 py-1 inline-block w-fit font-sans">{morData.assetQuery}</div>
            </div>
          </div>
          ...
          <ul className="list-disc pl-8 space-y-2 mt-4 ml-4">
            <li>I am solely responsible for the proper care, security, and maintenance of this equipment.</li>
            ...
            <li>I will surrender this asset in its current working condition (subject to normal wear and tear) upon separation from the company, or immediately upon request by Management.</li>
          </ul>
        </div>
        ...
        <div className="mt-20 pt-10 border-t border-gray-300">
          <div className="grid grid-cols-2 gap-16">
            <div>
              <p className="text-xs mb-10 text-gray-500 uppercase tracking-widest font-sans font-bold">Acknowledged & Received By:</p>
              <div className="border-b border-black pb-1 mb-2 h-10 flex items-end">
                {/* Signature goes here */}
              </div>
              <p className="font-bold text-sm">{morData.userQuery}</p>
            ...
            <div>
              <p className="text-xs mb-10 text-gray-500 uppercase tracking-widest font-sans font-bold">Issued & Verified By:</p>
              <div className="border-b border-black pb-1 mb-2 h-10 flex items-end">
                {/* Signature goes here */}
              </div>
              <p className="font-bold text-sm">Asset Management Officer</p>
