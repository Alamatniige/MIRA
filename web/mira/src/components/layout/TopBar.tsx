  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        {/* User Profile */}
        <div className="flex items-center gap-2.5 rounded-xl border border-teal-200/60 bg-white/80 px-3 py-2 shadow-sm transition-all duration-200 hover:border-teal-300 hover:shadow-md cursor-pointer group dark:border-[var(--mira-gray-200)] dark:bg-white/10 dark:hover:border-[var(--mira-gray-300)]">
          <div 
          ...
          <ChevronDown className="h-4 w-4 text-teal-500 transition-transform group-hover:rotate-180 dark:text-[var(--mira-gray-500)]" />
        </div>
      </div>
    </header>
  );
