  ...
  return (
    <group>
      ...
      <mesh position={[0, baseY - 0.25, 0]} receiveShadow>
        ...
        <meshStandardMaterial
          color={isDarkMode ? '#09090b' : '#e2e8f0'}
          metalness={0.5}
          roughness={0.2}
        />
      </mesh>
    ...
    <div className="w-full h-full min-h-400px cursor-grab active:cursor-grabbing">
      <Canvas shadows dpr={[1, 2]} camera={{ position: [10, 8, 10], fov: 32 }}>
        <Suspense fallback={null}>
          ...
          <spotLight position={[-20, 30, 20]} angle={0.15} penumbra={1} intensity={2} castShadow />
          ...
          <ContactShadows position={[0, -2.5, 0]} opacity={0.6} scale={20} blur={3} far={4.5} />
