    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <Button
          ...
          className="h-10 gap-2 rounded-xl bg-linear-to-r from-[#0F766E] to-[#0E7490] px-5 text-xs font-semibold text-white shadow-md transition-all hover:shadow-lg active:scale-95"
        >
