...
import { Package, Wrench, UserCheck, AlertCircle, PackagePlus, LucideIcon } from 'lucide-react';
...
export function NotificationItem({ notification, onClick }: NotificationItemProps) {
  const { icon: Icon, iconColor, iconBg } = ICON_MAP[notification.type] ?? ICON_MAP.report_created;
