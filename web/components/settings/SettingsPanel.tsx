  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                  ...
                  {role.name !== 'Admin' && (
                    <div className="flex items-center gap-1 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity mt-4 sm:mt-0">
                      <Button variant="ghost" size="icon" onClick={() => handleOpenRoleModal(role)} className="h-9 w-9 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 hover:text-emerald-600 dark:hover:text-emerald-400 text-slate-400">
                       ...
                       <Button variant="ghost" size="icon" onClick={() => confirmDeleteRole(role)} className="h-9 w-9 hover:bg-rose-50 dark:hover:bg-rose-500/10 hover:text-rose-500 dark:hover:text-rose-400 text-slate-400">
      ...
      <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
        <DialogContent className="sm:max-w-[400px] border-slate-200/60 dark:border-white/10 dark:bg-[#09090b]">
          <DialogHeader className="flex flex-col items-center justify-center pt-6 text-center">
            <div className="mb-4 rounded-full bg-rose-50 p-3 dark:bg-rose-500/10">
              <AlertTriangle className="h-6 w-6 text-rose-600 dark:text-rose-400" />
            </div>
            <DialogTitle className="text-lg font-bold text-slate-900 dark:text-white">Delete Role</DialogTitle>
          ...
          <DialogFooter className="grid grid-cols-2 gap-3 pb-6 border-none sm:justify-start">
            <Button 
              variant="outline" 
              onClick={() => setIsDeleteModalOpen(false)}
              className="w-full h-11 rounded-xl font-bold text-slate-600 dark:text-slate-300 dark:border-white/10"
            >
              Cancel
            </Button>
            <Button 
              onClick={deleteRole}
              className="w-full h-11 rounded-xl bg-rose-600 text-white font-bold hover:bg-rose-700 shadow-lg shadow-rose-500/20 active:scale-95 transition-all"
            >
              Delete Role
            </Button>
          </DialogFooter>
