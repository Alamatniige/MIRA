...
-- \restrict xseggrBO751R7KIzlgbw10wqpvo8xcDY8X3okab3K28HQmyjyPJ5KpzIEMVudfx
...
', 'White', 'Available', '2026-03-10 04:39:36.880957', false, 1, 2, 'AS-05', NULL),
	('9b206d15-f4be-43e7-b680-f869d2ce4ded', 'Mac Book M3 Pro', 1, '0123-2345-5678-12GE', 'Metallic Gray', 'Brand New', '2026-02-27 05:34:21.339847', true, 1, 1, 'AS-02', NULL),
	('e9da18f8-e008-479d-9f5c-6afe5545fb86', 'Lenovo Ideapad', 1, '0TY3-2345-5H48-12GE', 'Glossy Black', 'In Good Condition', '2026-02-27 03:31:05.80168', true, 1, 1, 'AS-03', '[]'),
	...
	('ea61acb2-26c9-4ee4-90a9-c6c8a92589ba', 'Attack Shark X11', 4, '1233-1233-1233-1233', 'White', 'Available', '2026-03-16 00:05:08.36615', false, 1, 2, 'AS-06', '["https://efdhhuibnmebekqkjjom.supabase.co/storage/v1/object/public/asset/76db7a5d-5007-41aa-908c-f75e8f4f24f7.webp", "https://efdhhuibnmebekqkjjom.supabase.co/storage/v1/object/public/asset/ddf74362-0d69-4e40-a242-ad6da870315f.webp", "https://efdhhuibnmebekqkjjom.supabase.co/storage/v1/object/public/asset/2610e6d3-6c44-444d-aa89-4c422e4c1460.jpg"]'),
	('65ba725c-d900-4482-b0a6-49689e378007', 'MSI Thin A15', 1, '1234-1234-1234-1234', 'Metalic Gray', 'Available', '2026-03-16 01:24:58.514213', false, 1, 2, 'AS-07', '["https://efdhhuibnmebekqkjjom.supabase.co/storage/v1/object/public/asset/43e15f33-0fed-4e4e-9e8b-c025481804eb.webp", "https://efdhhuibnmebekqkjjom.supabase.co/storage/v1/object/public/asset/7f53586e-19aa-4e74-95d7-cfc1cca482d6.webp"]');
...
INSERT INTO "public"."users" ("id", "email", "fullName", "password", "department", "createdAt", "roleId", "phoneNumber", "status", "lastActive", "assetCount", "assetsCount") VALUES
	...
	('37a8f454-8797-4aa9-b530-8c692c5695b4', 'sapioruiz23@gmail.com', 'John Doe', '$2a$10$yaPjup9FbTdGeHSW6hc2JOOqtJ/QNdQeuPdZOH1es.6hP9PoucvWO', 'Project Management', '2026-03-09 06:09:53.265658', 2, '+639927240717', 'active', NULL, NULL, 0),
	('515d239f-b702-478c-9a96-8504d1feedf0', 'dimaandalrim@gmail.com', 'Rim Vernon Dimaandal', '$2a$10$0jOQj.bn5p.JVeTromng3.MKRL22zzX5umqxiF88uTGbut0gGWare', 'IT', '2026-03-16 01:30:26.918941', 1, '123123123', 'active', NULL, NULL, 0);
...
INSERT INTO "public"."assetsAssignment" ("id", "userId", "assignedDate", "returnedDate", "acknowledged", "assetId", "notes", "issuedByUserId", "issuedByNameSnapshot", "rejectedAt", "rejectedByUserId", "rejectionReason") VALUES
	('0d6c7ddd-9ff1-49b2-a0f0-862c642d1bc4', '37a8f454-8797-4aa9-b530-8c692c5695b4', '2026-03-15 16:11:26.355268', NULL, true, 'e9da18f8-e008-479d-9f5c-6afe5545fb86', '', '4d78e3c2-8361-4a0e-8360-a717e2ed6d76', 'Ruiz Miguel Sapio', NULL, NULL, NULL),
...
INSERT INTO "public"."notifications" ("id", "type", "title", "description", "read", "createdAt", "performedBy") VALUES
	('b2b6afd9-9da5-4b7b-9403-244b6e9eb526', 'asset_registered', 'New asset registered', 'Ruiz Miguel Sapio registered MSI Thin A15 (AS-07).', false, '2026-03-16 01:25:00.071451+00', 'Ruiz Miguel Sapio');
...
-- \unrestrict xseggrBO751R7KIzlgbw10wqpvo8xcDY8X3okab3K28HQmyjyPJ5KpzIEMVudfx
